...
adminRoute.post(
  "/category",
  auth.isLogin,
  categoryController.checkUniqueCategory,
...
adminRoute.post(
  "/brand",
  auth.isLogin,
  brandController.checkUniqueBrand,
...
adminRoute.get(
  "/blockProductList",
  auth.isLogin,
  productController.blockProductList
);
adminRoute.get(
  "/unBlockProductList",
  auth.isLogin,
  productController.unBlockProductList
);
...
adminRoute.post(
  ...
  auth.isLogin,
  upload.array("image", 5),
  productController.loadEditProductList
);
